    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                builderTips.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(MainActivity.this,"你看完了提示，很好！",Toast.LENGTH_SHORT).show();
                    }
                });
                builderTips.show();
            }
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final View loginView=(View) layoutInflater.inflate(R.layout.login_layout,null);
